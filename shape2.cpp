...
class Rectangle{//defining and declaring a class called Rectangle
    ...
    public://to make the following members accessible outside the class
        ...
        void Rectangle::input()//function to take length and breadth from the user
            {
        ...
        int Rectangle::area()//function to calculate area of the rectangle
            {
                return (length*breadth);//returns area using formula length × breadth
            }
        int Rectangle::perimeter()//function to calculate perimeter of the rectangle
            {
